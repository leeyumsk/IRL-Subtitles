...
def audio_callback(indata, frames, time_info, status):
    ...
    global audio_buffer_a, audio_buffer_b, buffer_a_pos, buffer_b_pos, buffer_sel, odas_queue, odas_enabled
...
class AudioStreamHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        global buffer_sel, audio_buffer_a, audio_buffer_b, stream_active, odas_enabled
...
def main():
    ...
    global stream_active, audio_stream, odas_process, odas_enabled
    
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='Raspberry Pi 4-Mic I2S Audio Streaming Server with ODAS')
