# When connected to the ESP32-S3 wifi AP, this script can pull audio data from N microphones (N channels)
...
ESP32_IP = "192.168.4.254"  # IP address of the ESP32 (4-mic array)
